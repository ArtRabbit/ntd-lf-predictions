        ...
        <Layout>
            ...
            <Grid container spacing={4} >
                <Grid item md={8} xs={12} className={classes.contentLeftColumn}>
                    ...
                    <Typography className={classes.title} variant="h5" component="h2">Prevalence over time</Typography>
                ...
                <Grid item md={4} xs={12} className={classes.contentRightColumn}>
                    ...
                    <Typography className={classes.title} variant="h5" component="h2">Intervention</Typography>
                    ...
                    <FormControl className={classes.formControl}>
                        <Typography id="non-linear-slider" gutterBottom>Target coverage</Typography>
                    ...
                    <div className={classes.buttons}>
                        <Button variant="contained" color="primary">UPDATE SCENARIO</Button>
                        <Button variant="contained" color="primary">NEW SCENARIO</Button>
                    </div>
            ...
            <DiveDeeper
                ...
                links={[{ to: '/hot-spots', name: 'TRENDS FOR ALL COUNTRIES' }, { to: '/country', name: 'PROBLEM AREAS FOR ALL COUNTRIES' }]}
            />
